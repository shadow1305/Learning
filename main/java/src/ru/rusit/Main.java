 ...
 * Number[][] - двумерный массив, где количество элементов на каждом измерениии может отличаться.
 * Number[,] - двумерный массив, где количество элементов на каждом измерении не отличается.
 *
